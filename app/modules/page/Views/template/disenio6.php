<div class="caja-contenido-redonda p-3 d-flex justify-content-center" style="background-color: <?php if ($contenido->contenido_fondo_color) {
            ...
            <div class="modal-body">
                <div>
                    ...
                    <?php if ($contenido->contenido_enlace) { ?>
                        <div>
                            <a href="<?php $contenido->contenido_enlace; ?>" <?php if ($contenido->contenido_enlace_abrir == 1) { ?> target="_blank" <?php } ?> class="btn btn-block btn-vermas"> <?php if ($contenido->contenido_vermas) { ?><?php echo $contenido->contenido_vermas; ?><?php } else { ?>See More<?php } ?></a>
                        </div>
                    <?php } ?>
                </div>
            </div>
