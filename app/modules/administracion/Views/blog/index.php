	...
	<form action="<?php echo $this->route; ?>" method="post">
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            <label>blog_descripcion</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="blog_descripcion" value="<?php echo $this->getObjectVariable($this->filters, 'blog_descripcion') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
			...
			<tbody>
				...
				<?php $id =  $content->blog_id; ?>
					<tr>
						...
						<td><?=$content->blog_descripcion;?></td>
						<td class="text-end">
							<div>
