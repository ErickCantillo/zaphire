<?php
/**
* Controlador de Contenidocontroller que permite la  creacion, edicion  y eliminacion de los Contenido del Sistema
*/
class Administracion_contenidoController extends Administracion_mainController
{
	/**
	 * $mainModel  instancia del modelo de  base de datos Contenido
	 ...
	 * @var string
	 */
	protected $_csrf_section = "administracion_contenidocontroller";
	...
	/**
     * Inicializa las variables principales del controlador contenidocontroller .
     *
     * @return void.
     */
	public function init()
	{
		...
		$this->namepages ="pages_contenidocontroller";
		$this->namepageactual ="page_actual_contenidocontroller";
	...
	/**
     * Recibe la informacion y  muestra un listado de  Contenido con sus respectivos filtros.
     *
     * @return void.
     */
	public function indexAction()
	{
		$title = "Aministración de Contenido";
	...
	/**
     * Inserta la informacion de un contenido  y redirecciona al listado de Contenido.
     *
     * @return void.
     */
	public function insertAction(){
		...
		if (Session::getInstance()->get('csrf')[$this->_getSanitizedParam("csrf_section")] == $csrf ) {	
			...
			if($_FILES['contenido_fondo_imagen']['name'] != ''){
				$data['contenido_fondo_imagen'] = $uploadDocument->upload("contenido_fondo_imagen");
			}
	...
	/**
     * Recibe un identificador  y Actualiza la informacion de un contenido  y redirecciona al listado de Contenido.
     *
     * @return void.
     */
			...
			if ($content->contenido_id) {
				...
				if($_FILES['contenido_fondo_imagen']['name'] != ''){
					if($content->contenido_fondo_imagen){
						$uploadDocument->delete($content->contenido_fondo_imagen);
					}
					$data['contenido_fondo_imagen'] = $uploadDocument->upload("contenido_fondo_imagen");
				} else {
	...
	/**
     * Recibe un identificador  y elimina un contenido  y redirecciona al listado de Contenido.
     *
     * @return void.
     */
	...
	/**
     * Recibe la informacion del formulario y la retorna en forma de array para la edicion y creacion de Contenidocontroller.
     *
	...
	private function getData()
	{
		...
		$data['contenido_introduccion'] = $this->_getSanitizedParam("contenido_introduccion");
	...
	/**
     * Genera los valores del campo contenido_columna_alineacion.
     *
     * @return array cadena con los valores del campo contenido_columna_alineacion.
     */
