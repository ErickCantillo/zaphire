...
class Administracion_Model_DbTable_Publicidad extends Db_Table
{
	...
	public function insert($data){
		...
		$publicidad_padre = isset($data['publicidad_padre']) ? $data['publicidad_padre'] : 0;
		$mostrarinfo = $data['mostrarinfo'];

		$query = "INSERT INTO publicidad( publicidad_seccion, publicidad_nombre, publicidad_fecha, publicidad_imagen, publicidad_imagenresponsive, publicidad_video, publicidad_color_fondo, publicidad_posicion, publicidad_descripcion, publicidad_estado, publicidad_click, publicidad_enlace, publicidad_tipo_enlace, publicidad_texto_enlace, publicidad_padre, mostrarinfo) VALUES ( '$publicidad_seccion', '$publicidad_nombre', '$publicidad_fecha', '$publicidad_imagen', '$publicidad_imagenresponsive', '$publicidad_video', '$publicidad_color_fondo', '$publicidad_posicion', '$publicidad_descripcion', '$publicidad_estado', '$publicidad_click', '$publicidad_enlace', '$publicidad_tipo_enlace', '$publicidad_texto_enlace', '$publicidad_padre', '$mostrarinfo')";
