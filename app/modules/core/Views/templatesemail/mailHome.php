  ...
  <table style="max-width: 600px; background: #FFF; border: 2px solid #192a4b; margin: auto; padding: 20px;">
    <tr>
      <td style="border-bottom: 2px solid #192a4b;">
        <img src="https://alobiencs.com/assets/LogoALBien.png" alt="Logo ALBien" height="100"  style="display:block; margin:auto; margin-bottom:10px">
      </td> 
    </tr>
    <tr>
      <td style="padding: 10px 20px; padding-bottom: 20px;">
        <span style="color: #202020;">
         ...
         Se ha suscrito a la lista de correos con los siguientes datos:
        </span>
      </td>
    </tr>
    <tr>
